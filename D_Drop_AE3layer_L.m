...
%% Dropout
%p=0.4;
 dropout =0.2; % round(p * n1_neurons); 
...
dropout =0.2; % round(p * n2_neurons);
for i=1:epochs_ae
    for j=1:n
        % Feed-Forward
...
dropout =0.2; % round(p * n3_neurons);
